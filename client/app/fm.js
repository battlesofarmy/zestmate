...
export default function Chatbot() {
  ...
  const sendMessage = async () => {
    ...
    try {
      const { data } = await axios.post("https://zestmate-server.vercel.app/chat", { input });
  ...
  return (
    <section className="bg-gray-900 h-[100vh]">
      <div className="container">
        ...
        {/* Chat Area */}
        <div className="flex flex-col md:h-[78vh] h-[78vh] text-white mt-3">
            ...
            {messages.length > 0 ? (
                ...
                <div key={index}>
                  {msg.role === "user" ? (
                    ...
                    <div className="flex max-w-lg">
                      <div className="bg-gray-700 p-3 py-[10px] rounded-lg">
                        {msg.text}
                      </div>
                    </div>
                  )}
              ...
              <div className="md:pt-24 pt-16 text-center">
                <div>
                  ...
                  <p className="mt-2 text-sm md:w-[400px] mx-auto">
                    AI assistant of Z. H. Sikder University of Science & Technology Department of Computer Science & Engineering
                  </p>
                </div>
              </div>
            )}
